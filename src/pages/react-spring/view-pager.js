...
import styles from './styles/view-pager.less'
...
export default function () {
  ...
  return props.map(({ x, display, sc }, i) => (
    <animated.div className={styles.pagesWrap} {...bind()} key={i} style={{ display, transform: x.interpolate(x => `translate3d(${x}px,0,0)`) }}>
